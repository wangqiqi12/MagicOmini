...
pipe = pipe.to("cuda")
# NOTE: mind ckpt path!
local_path = "/root/private_data/wangqiqi12/Omini_ckpts/omni_ckpts/color_sketch_1024"
...
image = Image.open(f"./assets/example_infer.png").convert("RGB").resize((img_size, img_size))
...
result_img.save(f"example_out_{img_size}.jpg")
# 000018721
