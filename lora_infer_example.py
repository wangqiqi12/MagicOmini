...
pipe = pipe.to("cuda")
# NOTE: mind ckpt path!
local_path = "/root/private_data/wangqiqi/Omini_ckpts/lora_sketch_1024_1024_5w"
...
image = Image.open("./clean_out/cond_input.png").convert("RGB").resize((img_size, img_size))
...
result_img = generate(
    pipe,
    prompt="a stairway with red and blue carpeting",
    conditions=[condition],
    width=img_size,
    height=img_size,
).images[0]

result_img.save(f"example_out_{img_size}_12445.jpg")
